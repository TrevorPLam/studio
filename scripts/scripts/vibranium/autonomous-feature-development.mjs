...
async function main() {
  console.log("🚀 Autonomous Feature Development");
  ...
  learning.recordOutcome("autonomous-feature-development", "run", "success", {
    tier: 10,
...
main().catch((error) => {
  ...
  learning.recordOutcome("autonomous-feature-development", "run", "failure", { error: error.message });
  process.exit(1);
});
