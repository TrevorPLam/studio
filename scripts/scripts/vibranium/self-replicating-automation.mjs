...
async function main() {
  console.log("🚀 Self Replicating Automation");
  ...
  learning.recordOutcome("self-replicating-automation", "run", "success", {
    tier: 10,
...
main().catch((error) => {
  ...
  learning.recordOutcome("self-replicating-automation", "run", "failure", { error: error.message });
  process.exit(1);
});
