...
async function main() {
  console.log("🚀 Meta Meta Automation Creator");
  ...
  learning.recordOutcome("meta-meta-automation-creator", "run", "success", {
    tier: 10,
...
main().catch((error) => {
  ...
  learning.recordOutcome("meta-meta-automation-creator", "run", "failure", { error: error.message });
  process.exit(1);
});
