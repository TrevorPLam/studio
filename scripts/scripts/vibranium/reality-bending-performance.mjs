...
async function main() {
  console.log("🚀 Reality Bending Performance");
  ...
  learning.recordOutcome("reality-bending-performance", "run", "success", {
    tier: 10,
...
main().catch((error) => {
  ...
  learning.recordOutcome("reality-bending-performance", "run", "failure", { error: error.message });
  process.exit(1);
});
