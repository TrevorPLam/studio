...
async function main() {
  console.log("🚀 Predictive Everything Engine");
  ...
  learning.recordOutcome("predictive-everything-engine", "run", "success", {
    tier: 10,
...
main().catch((error) => {
  ...
  learning.recordOutcome("predictive-everything-engine", "run", "failure", { error: error.message });
  process.exit(1);
});
