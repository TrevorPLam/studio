...
async function main() {
  console.log("🚀 Ai Pair Programmer");
  ...
  learning.recordOutcome("ai-pair-programmer", "run", "success", {
    tier: 9,
...
main().catch((error) => {
  ...
  learning.recordOutcome("ai-pair-programmer", "run", "failure", { error: error.message });
  process.exit(1);
});
