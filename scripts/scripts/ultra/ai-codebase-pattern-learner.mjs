...
async function main() {
  console.log("🚀 Ai Codebase Pattern Learner");
  ...
  learning.recordOutcome("ai-codebase-pattern-learner", "run", "success", {
    tier: 9,
...
main().catch((error) => {
  ...
  learning.recordOutcome("ai-codebase-pattern-learner", "run", "failure", { error: error.message });
  process.exit(1);
});
