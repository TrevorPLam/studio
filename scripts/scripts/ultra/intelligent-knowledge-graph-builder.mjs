...
async function main() {
  console.log("🚀 Intelligent Knowledge Graph Builder");
  ...
  learning.recordOutcome("intelligent-knowledge-graph-builder", "run", "success", {
    tier: 8,
...
main().catch((error) => {
  ...
  learning.recordOutcome("intelligent-knowledge-graph-builder", "run", "failure", { error: error.message });
  process.exit(1);
});
