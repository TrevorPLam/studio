...
async function main() {
  ...
  learning.recordOutcome("intelligent-workflow-orchestrator", "run", "success", {
    tier: 7,
...
main().catch((error) => {
  ...
  learning.recordOutcome("intelligent-workflow-orchestrator", "run", "failure", { error: error.message });
  process.exit(1);
});
