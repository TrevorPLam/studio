...
async function main() {
  console.log("🚀 Self Adapting Test Suite");
  ...
  learning.recordOutcome("self-adapting-test-suite", "run", "success", {
    tier: 6,
...
main().catch((error) => {
  ...
  learning.recordOutcome("self-adapting-test-suite", "run", "failure", { error: error.message });
  process.exit(1);
});
