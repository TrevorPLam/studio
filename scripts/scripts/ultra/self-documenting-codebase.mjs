...
async function main() {
  console.log("🚀 Self Documenting Codebase");
  ...
  learning.recordOutcome("self-documenting-codebase", "run", "success", {
    tier: 5,
...
main().catch((error) => {
  ...
  learning.recordOutcome("self-documenting-codebase", "run", "failure", { error: error.message });
  process.exit(1);
});
