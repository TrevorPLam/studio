...
async function main() {
  console.log("🚀 Ai Codebase Oracle");
  ...
  learning.recordOutcome("ai-codebase-oracle", "run", "success", {
    tier: 9,
...
main().catch((error) => {
  ...
  learning.recordOutcome("ai-codebase-oracle", "run", "failure", { error: error.message });
  process.exit(1);
});
