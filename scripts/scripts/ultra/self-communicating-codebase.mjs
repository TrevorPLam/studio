...
async function main() {
  console.log("🚀 Self Communicating Codebase");
  ...
  learning.recordOutcome("self-communicating-codebase", "run", "success", {
    tier: 6,
...
main().catch((error) => {
  ...
  learning.recordOutcome("self-communicating-codebase", "run", "failure", { error: error.message });
  process.exit(1);
});
