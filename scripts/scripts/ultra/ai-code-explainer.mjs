...
async function main() {
  ...
  learning.recordOutcome("ai-code-explainer", "run", "success", {
    tier: 9,
...
main().catch((error) => {
  ...
  learning.recordOutcome("ai-code-explainer", "run", "failure", { error: error.message });
  process.exit(1);
});
