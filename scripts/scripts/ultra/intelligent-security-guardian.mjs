...
async function main() {
  console.log("🚀 Intelligent Security Guardian");
  ...
  learning.recordOutcome("intelligent-security-guardian", "run", "success", {
    tier: 6,
...
main().catch((error) => {
  ...
  learning.recordOutcome("intelligent-security-guardian", "run", "failure", { error: error.message });
  process.exit(1);
});
